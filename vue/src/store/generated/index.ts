...
import YazhiniXchainYazhiniXchainMlm from './yazhini/xchain/yazhini.xchain.mlm'
import YazhiniXchainYazhiniXchainXchain from './yazhini/xchain/yazhini.xchain.xchain'
...
export default { 
  ...
  YazhiniXchainYazhiniXchainMlm: load(YazhiniXchainYazhiniXchainMlm, 'yazhini.xchain.mlm'),
  YazhiniXchainYazhiniXchainXchain: load(YazhiniXchainYazhiniXchainXchain, 'yazhini.xchain.xchain'),
